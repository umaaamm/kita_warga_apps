...
class dropdownKasbon extends StatefulWidget {
  ...
  @override
  State<dropdownKasbon> createState() => _dropdownKasbonState();
}

class _dropdownKasbonState extends State<dropdownKasbon> {
